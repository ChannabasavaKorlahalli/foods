...
export function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    window.location.href = `mailto:exports@vaalifoods.com?subject=Export%20Quotation%20Request&body=${encodeURIComponent(body)}`;
    setSubmitted(true);
  };
      ...
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16">
          <Reveal>
            ...
            <h2 className="section-heading mt-4">Request an export quotation</h2>
          ...
          <Reveal delay={1}>
            <form onSubmit={handleSubmit} className="glass rounded-2xl p-6 lg:p-8">
              ...
              <button type="submit" className="btn-gold mt-6 w-full">
                Request Export Quotation <ArrowRight size={18} />
              </button>
              {submitted && (
