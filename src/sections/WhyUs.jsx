...
export function WhyUs({ embedded = false }) {
  return (
    <section id="why" className={embedded ? 'pb-12 lg:pb-16' : 'py-24 lg:py-32'}>
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        ...
        <div className={`grid gap-6 lg:grid-cols-3 lg:gap-8 ${embedded ? '' : 'mt-14'}`}>
          {WHY_US.map((item, i) => (
