...
export function Quality() {
  return (
    <section id="quality" className="border-y border-white/[0.06] bg-midnight py-24 lg:py-32">
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        <Reveal>
          <p className="eyebrow">Quality Assurance</p>
          <h2 className="section-heading mt-4">Trust Built on Transparency</h2>
        ...
        <div className="mt-14 grid gap-8 lg:grid-cols-[1.2fr_0.8fr]">
          <Reveal>
            <div className="glass rounded-2xl p-6 lg:p-8">
              <p className="text-xs uppercase tracking-[0.2em] text-creamMuted">Live specification dashboard</p>
