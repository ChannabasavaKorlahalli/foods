    ...
    <header className="fixed left-0 right-0 top-0 z-50 border-b border-white/10 bg-ink/70 backdrop-blur-xl">
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4 sm:px-8">
        <a href="#home" className="group flex min-w-0 shrink items-center gap-2 sm:gap-3">
          <img
            src={LOGO_SRC}
            alt="Vaali Foods — pulses trading"
            width={180}
            height={72}
            className="h-10 w-auto max-h-11 object-contain object-left sm:h-12 sm:max-h-14"
          />
        </a>
    ...
    >
      <div className="mx-auto max-w-3xl px-5 text-center">
        <Reveal>
          ...
          <h2 className="section-title mt-3 text-3xl sm:text-4xl">Vaali Foods</h2>
